...
public  class Transfer {
    ...
    public static void transfer(Accounts fromAccount, Accounts toAccount, Bank fromBank, Bank toBank,
        ...
        double amountFrom = fromBank.convert(fromAccount.getTypeOfCurrency(), fromBank.getBasicCurrency(), amount);
        //Комиссию реализовать тут
        double amountTo = toBank.convert(fromBank.getBasicCurrency(), toBank.getBasicCurrency(), amountFrom);
        double amountFinal = toBank.convert(toBank.getBasicCurrency(), toAccount.getTypeOfCurrency(), amountTo);
